...
public class SeedAdminUser {
    ...
    CommandLineRunner seedAdmins(AdminRepository repo, PasswordEncoder encoder) {
        return args -> {
            ...
            seed(repo, encoder, "testAdmin1", "testAdmin1", "Test", "Admin One", "testadmin1@sdp.com", "07751 246179", false);
            seed(repo, encoder, "testAdmin2", "testAdmin2", "Test", "Admin Two", "testadmin2@sdp.com", "07828 163035", false);
        };
    }
